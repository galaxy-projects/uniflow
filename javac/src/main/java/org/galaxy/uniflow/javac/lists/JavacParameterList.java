...
public class JavacParameterList extends JavacList<UniParameter, JCTree.JCVariableDecl> implements UniParameterList {

    public JavacParameterList(
            Supplier<List<JCTree.JCVariableDecl>> elementsSupplier,
            Consumer<List<JCTree.JCVariableDecl>> setter,
            Function<JCTree.JCVariableDecl, UniParameter> wrapper,
            Function<UniParameter, JCTree.JCVariableDecl> unwrapper) {
