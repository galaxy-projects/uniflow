...
public class JavacOpens extends JavacElement<JCTree> implements UniOpens {

    private static final ReflectField QUALIFIER_ID;
    private static final ReflectField MODULE_NAMES;

    public JavacOpens(@NotNull JCTree tree) {
        super(tree);
    }
    ...
    static {
        try {
            ReflectClass type = new ReflectClass(Reflection.OPENS_TYPE);
